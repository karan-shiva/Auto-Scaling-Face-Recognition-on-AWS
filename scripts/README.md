...
- [Testing Script](https://github.com/karan-shiva/Auto-Scaling-Face-Recognition-on-AWS/scripts/testing.py):

  - How to use the script:
    ```
    usage: testing.py [-h] [--access_keyId ACCESS_KEYID] [--access_key ACCESS_KEY] [--req_sqs REQ_SQS] [--resp_sqs RESP_SQS] [--in_bucket IN_BUCKET] [--out_bucket OUT_BUCKET]
    Grading Script  
    options:
